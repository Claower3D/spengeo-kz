...
# Insert default consts before loadInitialAdminData
content = content.replace("const loadInitialAdminData = () => {", new_defaults + "\nconst loadInitialAdminData = () => {")
...
# Safely replace `return parsed;` inside loadInitialAdminData
content = content.replace("      return parsed;", new_init_additions, 1)

with open('c:/Users/SystemX/Documents/строй/frontend/src/App.jsx', 'w', encoding='utf-8') as f:
    f.write(content)

print("Injected default arrays safely!")
