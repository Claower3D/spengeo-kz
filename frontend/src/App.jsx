          ...
          <div className="page-wrapper page-enter">
            ...
            <div className="geological-layer-content">
              ...
              <div style={{ textAlign: 'center', marginBottom: '40px', position: 'relative', zIndex: 2 }}>
                 <EditableText as="h2" id="stats_title" defaultText={t.stats.title} isVisualBuilder={isVisualBuilder} style={{ fontSize: '3.2rem' }} />
              </div>
              ...
              <section className="container bento-grid" style={{ paddingBottom: '100px', position: 'relative', zIndex: 10 }}>
                ...
                <div className="glow-card-premium bento-card bento-large float-slow">
                  ...
                  <EditableText id="stats_wells_val" defaultText="1,420+" isVisualBuilder={isVisualBuilder} as="div" className="spec-val" style={{ fontSize: 'clamp(4rem, 8vw, 6rem)', fontWeight: 900, color: 'var(--color-accent)', fontFamily: 'var(--font-display)', lineHeight: 1, marginBottom: '20px' }} />
                ...
                <div className="glow-card-premium bento-card float-reverse">
                  ...
                  <EditableText id="stats_geo_val" defaultText={t.stats.geoValue} isVisualBuilder={isVisualBuilder} as="div" style={{ fontSize: '3rem', fontWeight: 800, color: 'var(--color-cyan)', fontFamily: 'var(--font-mono)', lineHeight: 1, marginBottom: '15px' }} />
                ...
                <div className="glow-card-premium bento-card float-slow">
                  ...
                  <EditableText id="stats_standards_val" defaultText="100%" isVisualBuilder={isVisualBuilder} as="div" style={{ fontSize: '3rem', fontWeight: 800, color: 'var(--color-accent)', fontFamily: 'var(--font-mono)', lineHeight: 1, marginBottom: '15px' }} />
                ...
                <div className="glow-card-premium bento-card bento-wide float-fast" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <div style={{ flex: 1, textAlign: 'right' }}>
                    <EditableText id="stats_fleet_val" defaultText={t.stats.fleetValue} isVisualBuilder={isVisualBuilder} as="div" style={{ fontSize: '4.5rem', fontWeight: 800, color: 'var(--color-cyan)', fontFamily: 'var(--font-mono)', lineHeight: 1 }} />
                  </div>
...
<div className="service-bento-grid">
  ...
  <div className="service-bento-card full" onClick={() => {setActiveServiceTab('laboratory'); setActivePage('services');}}>
              ...
              <div className="glow-card-premium" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '0', alignItems: 'stretch', padding: '0', overflow: 'hidden', position: 'relative', zIndex: 2, background: 'var(--bg-card)', border: '1px solid var(--border-color)', boxShadow: '0 0 50px rgba(0,0,0,0.1)', marginBottom: '60px' }}>
                  ...
                  <div style={{ padding: '60px', display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative' }}>
                    ...
                    <div style={{ position: 'relative', zIndex: 2 }}>
                      ...
                      <EditableText as="p" id="history_f_quote" dangerously={true} defaultText="Аскар Уалиевич — директор ТОО «СпецИнжГео», доктор философии (PhD) в области строительства и геотехники. Специализируется на инженерно-геологических изысканиях, геотехническом сопровождении строительства, проектировании оснований и фундаментов, а также внедрении современных технологий исследования грунтов.<br/><br/>Под его руководством компания успешно реализует проекты промышленного, гражданского и инфраструктурного строительства по всей территории Казахстана. Особое внимание уделяется качеству выполняемых инженерных изысканий, применению современного оборудования, соблюдению требований СП РК, ГОСТ и международных стандартов, а также поиску эффективных инженерных решений для каждого объекта.<br/><br/>Основной принцип работы — профессионализм, инженерная точность и ответственность перед заказчиком. Благодаря сочетанию научного подхода, практического опыта и современных технологий ТОО «СпецИнжГео» обеспечивает высокое качество выполняемых работ, а техническая документация компании успешно проходит государственную и ведомственную экспертизу." isVisualBuilder={isVisualBuilder} style={{ color: 'var(--color-text-secondary)', fontSize: '1.1rem', lineHeight: 1.8, position: 'relative', zIndex: 2, fontStyle: 'italic', borderLeft: '3px solid var(--color-cyan)', paddingLeft: '25px' }} />
                    </div>
                  </div>
                </div>
            ...
            <div className="responsive-grid-2col" style={{ gap: '50px', alignItems: 'flex-start' }}>
              <div>
                <HudCard style={{ marginBottom: '30px' }}>
                  ...
                  <p style={{ color: 'var(--color-text-secondary)', fontSize: '0.95rem', marginBottom: '15px' }}>
                    📞 Телефон: <EditableText id="contacts_phone_val" defaultText={adminData.global?.phone || '+7 705 969 0101'} isVisualBuilder={isVisualBuilder} />
                  </p>
                  <p style={{ color: 'var(--color-text-secondary)', fontSize: '0.95rem', marginBottom: '15px' }}>
          ...
          <div className="footer-grid">
            ...
            <div>
              ...
              <ul className="footer-links" style={{ fontSize: '0.85rem' }}>
                ...
                <li>📞 <EditableText id="footer_phone" defaultText={adminData.global?.phone || '+7 705 969 0101'} isVisualBuilder={isVisualBuilder} /></li>
    ...
    <div className="service-bento-arrow">
      ...
      <a href="https://wa.me/77059690101" target="_blank" rel="noopener noreferrer" className="fixed-action-btn whatsapp-btn" title="Написать в WhatsApp">
